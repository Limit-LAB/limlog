...
use crate::{
    consts::{INDEX_MAGIC, LOG_MAGIC, MIN_LOG_SIZE},
...
pub(crate) const LOG1: [u8; 34] = [
    ...
    0x00, // uuid
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01, // key length
    0x01, // key
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01, // value length
    0x0A, // value
];
...
pub(crate) const LOG_FILE_HEADER: [u8; 24] = [
    ...
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x03, /* entry_count
           * logs */
];
...
pub(crate) const INDEX1: [u8; 24] = [
    0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, // uuid
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x18, // offset
];
pub(crate) const INDEX2: [u8; 24] = [
    0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, // uuid
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x3A, // offset
];
pub(crate) const INDEX3: [u8; 24] = [
    0x00, 0x00, 0x00, 0x00, 0x00, 0x03, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, // uuid
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x5C, // offset
];
...
fn test_log_format() {
    ...
    assert_eq!(
        LogFileHeader {
            magic_number: u64::from_be_bytes(*LOG_MAGIC),
            attributes: 0,
            entry_count: 3
        },
        lh
    ...
    assert_eq!(
        IndexFileHeader {
            magic_number: u64::from_be_bytes(*INDEX_MAGIC)
        },
        idx_h
    );
}
